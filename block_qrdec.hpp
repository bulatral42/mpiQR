...
#ifndef MPIQR_BLOCK_QRDEC_HPP
#define MPIQR_BLOCK_QRDEC_HPP
...
void block_qrdec(int N, int block_size, int subblock_size, //void (* init_block)(int, int, int, int, double *),
